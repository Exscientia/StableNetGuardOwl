...
[//]: # (Badges)
[![GH Actions Status](https://github.com/Exscientia/StableNetGuardOwl/workflows/CI/badge.svg)](https://github.com/Exscientia/StableNetGuardOwl/actions/workflows/CI.yaml?query=branch%3Amain)
